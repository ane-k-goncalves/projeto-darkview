import { FilmesApi } from "../service/script";

window.onload = function () {

    let filmesApi = new FilmesApi();
    ...
    filmesApi
        ...
        .then(products => {
            ...
            const filmesList = document.getElementById('movies-container');
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        ...
                                        Gênero: ${movie.genre_ids.join(', ')} <br>
                                    </p>
            ...
            filmesList.innerHTML = cardListContent;
